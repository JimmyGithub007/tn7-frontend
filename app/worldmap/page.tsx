...
const buildings = [
    ...
    { id: 3, name:"SILVERCOIN DISTRICT", img: "b3", content: "<p>The SilverCoin District is located in the lower part of SynthCity, a place where hope is scarce and survival is the only priority. The district is home to smaller clans, each vying for control and influence.</p>" },
    { id: 4, name:"THE WATERING HOLE", img: "b4", content: "<p>At the heart of Cyber Valley lies The Watering Hole, a bustling marketplace where merchants gather to promote their latest technological innovations and services. Deals are made in the open, but for those who know where to look, even the rarest and most illicit tech can be acquired for the right price.</p>" },
    { id: 5, name:"KOI AND LOTUS CLUB", img: "b5", content: "<p>The Koi and Lotus Club is Cyber Valley’s premier hotspot, a hub for power plays and secret deals. Beneath its lavish exterior, the club serves as the legitimate front for The Misfits' operations, seamlessly balancing legal ventures with underground operations, primarily hacking and information brokering.</p>" },
    { id: 6, name:"THE CODEX", img: "b6", content: "<p>The Codex is a sanctuary of knowledge, housing ancient wisdom alongside cutting-edge breakthroughs. It serves as a pivotal center for scholars, technologists, and seekers of knowledge. Within its walls lies a profound repository of intellectual discovery and exploration.</p>" },
