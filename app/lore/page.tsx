...
const details = [
    {
        id: "1", category: "cities", detail: `<p>The city is a fascinating mix of old traditions and new technology, where ancient buildings stand side by side with gleaming skyscrapers. A perpetual red glow illuminates the city, casting a warm and reddish light on everything it touches. This crimson hue comes from the city's unique energy grid, powered by an ancient power that the locals seldom discussed and often regarded as legend.</p>
            ...
            <br/>
            <p class="text-sm">Major landmarks</p>
            <div class="text-xs">
                <a class="underline text-red-800" href="/lore?category=locations&id=2">The Pinnacle Towers</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=1">The Temple on the hill</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=3">The Lower District (Silver Coin District)</a> 
            </div>`
    },
    {
        id: "2", category: "cities", detail: `<p>Cyber Valley is situated adjacent to SynthCity, separated by a strip of land (The Black Zone) filled with rundown, abandoned old houses and factories. The ownership of the land remains disputed between the two cities, resulting in the area now serving as a contentious buffer zone between them.</p><br/>
            ...
            <p class="text-sm">Major landmarks</p>
            <div class="text-xs">
                <a class="underline text-red-800" href="/lore?category=locations&id=6">The Koi and Lotus Club</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=5">The Codex</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=4">The Watering Hole</a> 
            </div>`
    },
    {
        id: "3", category: "cities", detail: `<p>New Helm is an industrial city built on concrete and rich in geothermal energy. Yet, despite its wealth, the society remains far from flourishing. Under the iron rule of the Akio Family, the city is tightly controlled—surveillance is pervasive, and guards patrol every corner. Nothing moves through New Helm unnoticed. Every transaction, shipment, and visitor is meticulously monitored, and entry is only granted to those with a special permit.</p><br/>
            ...
            <p class="text-sm">Major landmarks</p>
            <div class="text-xs">
                <a class="underline text-red-800" href="/lore?category=locations&id=8">Akio Industries</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=7">The Fort</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="underline text-red-800" href="/lore?category=locations&id=9">The Energy Field</a> 
            </div>`
    },
    ...
    {   id: "3", category: "locations", detail: `<p>The underbelly of SynthCity, where survival takes precedence over everything else. Seemingly forgotten by time and progress, the district is marked by narrow, cluttered streets lined with dilapidated buildings and flickering street lights. The buildings are old and crumbling, their facades faded and cracked. The air is thick with smoke, and the scent of decay fills the space.</p><br />
            ...
            <br/>
            <div class="text-sm">Location&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=1">SynthCity</a></div>
            <div class="text-sm">Appearance&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=1">To be revealed</a></div>`
    },
    {   id: "4", category: "locations", detail: `<p>At the core of Cyber Valley lies a bustling marketplace where vendors assemble to sell their latest tech offerings. The Watering Hole has a massive retractable dome that looms overhead, shielding the square from harsh weather, ensuring that trade never stops. Encircling the market is a circular wall, its intricate mechanical panels, glowing lights, and exposed machinery giving it an industrial look. A vibrant blue light pulses from its base, casting a luminous glow over the marketplace.</p><br />
            ...
            <br/>
            <div class="text-sm">Location&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=2">Cyber Valley</a></div>
            <div class="text-sm">Appearance&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=2">Secret of the Valley</a></div>`
    },
    {   id: "5", category: "locations", detail: `<p>The premier hotspot of Cyber Valley—a hub for power plays and secret deals. The Koi and Lotus Club is a sight to behold. A pair of massive koi holograms glide gracefully above a luminous lotus flower. The neon glow radiating from the lotus casts vibrant reflections on their shimmering scales, creating a mesmerizing dance of light and color. The two koi symbolize the dual nature of the club—one side steeped in legitimacy, the other entrenched in the underground.</p><br />
            ...
            <br/>
            <div class="text-sm">Location&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=2">Cyber Valley</a></div>
            <div class="text-sm">Appearance&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=2">Path of Vengeance</a></div>`
    },
    ...
    {   id: "7", category: "locations", detail: `<p>The Fort serves as the city’s only access point. A heavily fortified mechanized gate, reinforced with red titanium bars, is flanked by automated turrets and towering machine gun emplacements. Guards patrol the perimeter around the clock, their presence constant and unyielding. High-powered surveillance cameras and motion sensors are strategically positioned to track every movement, ensuring that nothing enters or exits unnoticed.</p><br />
            ...
            <br/>
            <div class="text-sm">Location&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=3">New Helm</a></div>
            <div class="text-sm">Appearance&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=3">Path of Vengeance</a></div>`
    },
    ...
    {   id: "9", category: "locations", detail: `<p>The Energy Field, built by Akio Industries, is used to extract geothermal energy. At its core, a colossal turbine spins continuously, activating the drills. The structure is surrounded by angular, reinforced walls that house essential processing and monitoring stations.</p>
            ...
            <br/>
            <div class="text-sm">Location&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=3">New Helm</a></div>
            <div class="text-sm">Appearance&nbsp;&nbsp;:&nbsp;&nbsp;<a class="underline text-red-800" href="/lore?category=cities&id=3">To be revealed</a></div>`
    },
]
